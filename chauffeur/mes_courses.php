...
<nav class="mobile-nav">
    <div class="mn-inner">
        ...
        <a class="mnav-item" href="notifications.php"><i class="bi bi-bell-fill"></i>Alertes</a>
        <a class="mnav-item" href="#"><i class="bi bi-graph-up-arrow"></i>Revenus</a>
        <a class="mnav-item" href="#"><i class="bi bi-person-fill"></i>Profil</a>
    </div>
</nav>
