                        ...
                        <div style="overflow-x:auto">
                            <table class="tx-table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td style="font-family:var(--font-mono);font-size:11px;color:var(--n400)">#<?= $tx['id'] ?></td>
                                        <td>
                                            <div class="tx-route">
...
<nav class="mobile-nav">
    <div class="mn-inner">
        <a class="mnav-btn" href="dashboard_chauffeur.php"><i class="bi bi-house-fill"></i>Accueil</a>
        <a class="mnav-btn" href="dashboard_chauffeur.php#section-courses"><i class="bi bi-map-fill"></i>Courses</a>
