...
?>
    ...
    <div class="stats">
      <div class="stat">
        <div class="stat-ic g"><i class="bi bi-truck"></i></div>
        <div><div class="stat-val"><?= $totalV ?></div><div class="stat-lbl">Total véhicules</div></div>
      </div>
      <div class="stat">
        <div class="stat-ic g"><i class="bi bi-check-circle-fill"></i></div>
        <div><div class="stat-val"><?= $totaux['disponible'] ?? 0 ?></div><div class="stat-lbl">Disponibles</div></div>
      </div>
      <div class="stat">
        <div class="stat-ic b"><i class="bi bi-arrow-repeat"></i></div>
        <div><div class="stat-val"><?= $totaux['en service'] ?? 0 ?></div><div class="stat-lbl">En service</div></div>
      </div>
      <div class="stat">
        <div class="stat-ic r"><i class="bi bi-x-circle-fill"></i></div>
        <div><div class="stat-val"><?= $totaux['indisponible'] ?? 0 ?></div><div class="stat-lbl">Indisponibles</div></div>
      </div>
    </div>
